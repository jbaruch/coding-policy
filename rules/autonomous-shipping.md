...
- Merge approval is exactly `skills/release/SKILL.md` Step 7's preconditions — load Step 7 before merging; this rule never restates them and never adds an approval field
