...
- Never resend a refused brief to the same provider, and never reword it for any provider
- Move a refused brief unchanged to one other provider; a second refusal stops the line for the operator
