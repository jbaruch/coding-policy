...
`composer_glyph`, `composer_ignore_dim`, and `recover_keys` drive the
consumed-command check, the ghost-text exemption, and the one-shot recovery of
a stuck composer. All are documented in
