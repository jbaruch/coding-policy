"""Tests for foreman.measure. The herdr client is always a fake."""
...
from foreman.measure import DEFAULT_READ_LINES, ready_agents
from foreman.measure import measure as _measure
from foreman.measure import measure_agent as _measure_agent
from foreman.measure import skipped_record
from foreman.measure import wait_for_usage_report as _wait_for_usage_report
...
class WindowGroupPassthroughTest(unittest.TestCase):
    ...
    def test_a_skipped_record_carries_it_too(self):
        # A pool-mate foreman declined to interrupt still shares the window;
