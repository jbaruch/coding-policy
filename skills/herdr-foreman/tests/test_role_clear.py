...
class RoleClearTests(fixture.fixture.CliCase):
    ...
    def seed_role_clear(self, fix=2):
        ...
        with patch("foreman.cli.recovery.developer_reservations", return_value={}):
        ...
        return {"id": "role-clear-next", "task": TASK, "base_revision": BASE, "assignment_index": fix,
                ...
                "evidence": str(self.evidence), "reason": "The foreman reused the developer for another authorized tester role"}
    ...
    def test_schema_two_migration_preserves_history_and_adds_empty_recovery_arrays(self):
        ...
        expected["recovery"].update(schema_version=recovery.RECOVERY_STORE_VERSION, role_clearances=[], delivery_recoveries=[], refusal_authorizations=[], diagnoses=[], legacy_ruling_recoveries=[], approaches=[])
