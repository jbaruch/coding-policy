...
`skills/herdr-foreman/references/working-memory.md`. Link each lesson to this
...
`skills/herdr-foreman/references/attention.md`. These records supplement the
...
in `skills/herdr-foreman/state-schema.md`. Record that directory in the foreman's
...
Run the installed `skills/herdr-foreman/foreman.sh` with an explicit `bash`
