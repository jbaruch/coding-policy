...
Consumer repos carry no per-repo review workflow and no `CODEX_AUTH_JSON`. The central fleet App (coding-policy#202) reviews them, running from coding-policy against the consumer's tessl-installed `.tessl/plugins/.../rules/`.
