...
| Scope | [external-repo-contributions](rules/external-repo-contributions.md) | Default deny on issues, PRs, comments, reactions in repos the operator does not own; explicit permission required per target |
