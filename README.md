...
| [herdr-teamlead](skills/herdr-teamlead/SKILL.md) | Lead coding rounds in [Herdr](https://herdr.dev): measure headroom, assign developer / tester / reviewer roles, compose briefs, provision worktrees, dispatch workers, and gate release on their reports. Per-round model and effort selection uses verified relaunches, qualification gates, and measured or explicitly unknown billing windows. A pinned judge rules on disputes and exhausted fix loops. |
